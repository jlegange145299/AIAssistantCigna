...
def main():
    ...
    image_path = r'C:\Users\jacqu\assistant-api-streamlit-chatbot\2.png'
    ...
    slider_value = st.sidebar.slider("How satisfied were you with your last Cigna interaction?", 0, 100, 50)
    
    image_path = r'C:\Users\jacqu\assistant-api-streamlit-chatbot\new.png'
    st.sidebar.image(image_path, caption='')
    

    api_key = "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"
    ...
    if st.session_state.start_chat:
        ...
        if prompt := st.chat_input("Hello how can I help?"):
            ...
            with st.chat_message("assistant"):
                ...
                engine.runAndWait()
                #speak_thread = threading.Thread(target=speak_text, args=(processed_response,))
                #speak_thread.start()
